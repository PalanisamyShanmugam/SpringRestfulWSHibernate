...
<div id="container" >
	...
	<div id="wrapper">
		...
		<form  action="searchSubjectInfoByDuration" method="post"> 
				<p><b>Search a Subject</b></p> 
		
		 
          <div class="form-group">
			  <label for="start_date" class="title">Enter Start Date:</label>  
			  <input type="text" id="start_date" name="start_date" class="form-control" required="required" placeholder="Enter Start Date">
          </div>
           <div class="form-group">
			  <label for="end_date" class="title">Enter End Date:</label>  
			  <input type="text" id="end_date" name="end_date" class="form-control" required="required" placeholder="Enter End Date">
          </div>
		   
		   <p style="line-height: 10px; text-align: center;"><button class="btn btn-primary">Search a Subject</button></p>
