...
<div id="container" >
	...
	<div id="wrapper">
		...
		<form  action="findByBookTitle" method="post"> 
				<p><b>Search a Book</b></p> 
		
		 
          <div class="form-group">
			  <label for="book_title" class="title">Enter a Book Title:</label>  
...
<p style="line-height: 10px; text-align: center;"><button class="btn btn-primary">Back To Home</button></p>
	...
	<c:if test="${empty bookList && isVisible}">
		...
		<h2>BookInfo does not exist for bookTitle: ${book_title}</h2>
